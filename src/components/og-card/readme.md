...
| Name                              | Description                             |
| --------------------------------- | --------------------------------------- |
| `--og-card-BackgroundColor`       | Overall background color of the card    |
...
| `--og-card__header-Padding`       | Padding of the cards header             |
| `--og-card__header-TextTransform` | Text transformation of the cards header |
